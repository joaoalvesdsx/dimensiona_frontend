...
export const getAdmins = async (): Promise<Admin[]> => {
    ...
    console.warn("API para listar admins não encontrada no backend. Retornando array vazio.");
...
export const updateSitioFuncional = async (sitioId: string, data: Partial<CreateSitioFuncionalDTO>): Promise<SitioFuncional> => {
...
export const getCargosPorSitio = async (sitioId: string): Promise<CargoSitio[]> => {
    const response = await api.get(`/sitios/sitios-funcionais/${sitioId}/cargos`);
    return response.data.data;
};
export const addCargoASitio = async (sitioId: string, data: { cargoUnidadeId: string, quantidade_funcionarios: number }): Promise<CargoSitio> => {
    const response = await api.post(`/sitios/sitios-funcionais/${sitioId}/cargos`, data);
    return response.data;
};
export const deleteCargoDeSitio = async (cargoSitioId: string): Promise<void> => {
...
export const getColetasPorHospital = async (hospitalId: string): Promise<Coleta[]> => {
