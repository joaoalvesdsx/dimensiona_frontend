                        ...
                        unidades.map(unidade => (
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h2 className="text-xl font-semibold text-primary">{unidade.nome}</h2>
                                        <p className="mt-1 text-sm text-gray-600">{unidade.leitos?.length || 0} leitos</p>
                                    </div>
                                </div>
                            </Link>
                        ))
                    ) : (
                        <p className="col-span-full text-center text-gray-500">Nenhuma unidade de internação encontrada para este hospital.</p>
                    )}
                </div>
            )}
        </div>
